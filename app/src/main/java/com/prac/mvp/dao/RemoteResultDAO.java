...
//    @GET("/2.0/?method=artist.search&artist={artist}&api_key={apiKey}&format={returnFormat}")
...
//    @GET("/2.0/?method=album.search&album={album}&api_key={apiKey}&format={returnFormat}")
...
//    @GET("/2.0/?method=track.search&track={track}&api_key={apiKey}&format={returnFormat}")
